 ...
 * @author omarjcm
 */
public class OBPGrasp_01 extends OBPGraspAlgorithm {
    
    public OBPGrasp_01(ArrayList<Order> orders, int capacityByBatch) {
        super(orders);
        this.capacityByBatch = capacityByBatch;
        this.alpha = Math.random();
    }
    
    public OBPGrasp_01(ArrayList<Order> orders, int capacityByBatch, double alpha) {
        super(orders);
        this.capacityByBatch = capacityByBatch;
        this.alpha = alpha;
    }
